...
int main() {
    ...
    do {
        ...
        cout << setfill('-') << setw(50) << "--" << endl;
        cout << setfill(' ') << setw((50 - 8) / 2) << "" << "PLIK" << setw((50 - 4) / 2) << "" << endl;
        cout << setfill('-') << setw(50) << "--" << endl;
        cout << "9. Zapis do pliku." << endl;
        cout << "10. Odczyt z pliku." << endl;
        cout << setfill('-') << setw(50) << "--" << endl;
        cout << setfill('=') << setw(50) << "==" << endl;
        ...
        case 3: {
            ...
            cout << endl;
            cout << "Przykladowy numer zawodnika: ";
            for (int k = 0; k < 1; k++) {
                cout << listanr[k] << " ";
            }
            cout << endl;
        ...
        case 4: {
            ...
            cout << "19-20 , 20+ , Pary, Studenci(20-24) ." << endl;
            cout << setfill('-') << setw(50) << "--" << endl;
